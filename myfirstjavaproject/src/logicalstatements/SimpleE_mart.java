...
<<<<<<< HEAD
public class SimpleE_mart {// open brace of class
...
public class SimpleE_mart {//open brace of class
	...
	public static void main(String[] args) {//open brace for main method
		System.out.println("WELCOME TO THE E-FRUITS AND VEGETABLE MARKET");
		System.out.println("========================================================");
		System.out.println("AVALIABLE ITEMS IN FURITS\n-|APPLE  |200RS PER KG\n-|BANANA |80RS PER DOZEN \n-|MANGO  |100RS PER KG");
		System.out.println("AVALIABLE ITEMS IN VEGETABLES\n-|POTATO  |50RS PER KG\n-|TOMATO  |30 PER KG\n-|CARROT  |60 PER KG");
		System.out.println("========================================================");
		...
		case 1 -> {//open brace for fruits cases
			...
			case "apple", "APPLE" -> {//open brace for apple
				...
				int cost = 200;
				switch (kg) {//open brace for kgs
				case 0 -> {System.out.println("COST OF APPLES FOR HALF KG IS" + (cost / 2)); total=total+(cost/2);bill = bill + "Apple\t\tHALF KG\t" + cost/2 + "\n";}
				case 1 -> {System.out.println("COST OF APPLES FOR 1 KG IS " + cost);total+=cost;bill = bill + "Apple\t\t1 KG\t" + cost + "\n";}
				case 2 -> {System.out.println("COST OF APPLES FOR 2 KG IS " + (cost * 2));total+=cost*2;bill = bill + "Apple\t\t2 KG\t" + cost*2 + "\n";}
				case 3 -> {System.out.println("COST OF APPLES FOR 3 KG IS " + cost * 3);total+=cost*3;bill = bill + "Apple\t\t1 KG\t" + cost*3 + "\n";}
				default -> {System.out.println("PLEASE ENTER IN THE RANGE OF 1-3");}
			...
			case "banana", "BANANA" -> {//open brace for banana
				...
				int cost = 80;
				switch (kg) {//open brace for dozens
				case 0 ->{ System.out.println("COST OF BANANA FOR HALF DOZEN IS" + (cost / 2));  total=total+(cost/2);bill = bill + "BANANA\t\tHALF DOZEN\t" + cost/2 + "\n";}
				case 1 -> {System.out.println("COST OF BANANA FOR 1 DOZEN IS " + cost);total+=cost;bill=bill+"BANANA\t\t1 DOZEN\t" + cost + "\n";}
				case 2 -> {System.out.println("COST OF BANANA FOR 2 DOZEN " + (cost * 2));total+=cost*2;bill=bill+"BANANA\t\t2 DOZEN\t" + cost*2 + "\n";}
				case 3 -> {System.out.println("COST OF BANANA FOR 3 DOZEN " + cost * 3);total+=cost*3;bill=bill+"BANANA\t\t3 DOZEN\t" + cost*3 + "\n";}
				default -> System.out.println("PLEASE ENTER IN THE RANGE OF 1-3");
				}//close brace for dozens
				System.out.println("========================================================");
				}//open braces for banana
			case "mango", "MANGO" -> {//open brace for MANGO
				...
				int cost = 100;
				switch (kg) {//open brace for kgs
				case 0 ->{ System.out.println("COST OF MANGO FOR HALF KG IS" + (cost / 2)); total=total+(cost/2);bill = bill + "MANGO\t\tHALF KG\t" + cost/2 + "\n";}
				case 1 ->{ System.out.println("COST OF MANGO FOR 1 KG IS " + cost);total+=cost;bill = bill + "MANGO\t\t1 KG\t" + cost + "\n";}
				case 2 -> {System.out.println("COST OF MANGO FOR 2 KG IS" + (cost * 2));total+=cost*2;bill = bill + "MANGO\t\t2 KG\t" + cost*2 + "\n";}
				case 3 -> {System.out.println("COST OF MANGO FOR 3 KG IS" + cost * 3);total+=cost*3;bill = bill + "MANGO\t\t3 KG\t" + cost*3 + "\n";}
				default -> System.out.println("PLEASE ENTER IN THE RANGE OF 1-3");
				}//close brace for kgs
				System.out.println("========================================================");
			}//close brace for MANGO
		...
		case 2 ->{//open brace for case 2
			...
			case "potato"->{
				...
				int cost = 50;
				switch (kg) {//open brace for kgs
				case 0 -> {System.out.println("COST OF POTATO FOR HALF KG IS" + (cost / 2)) ;total=total+(cost/2);bill = bill + "POTATO\t\tHALF KG\t" + cost/2 + "\n";}
				case 1 -> {System.out.println("COST OF POTATO FOR 1 KG IS " + cost);total+=cost;bill = bill + "POTATO\t\t1 KG\t" + cost + "\n";}
				case 2 -> {System.out.println("COST OF POTATO FOR 2 KG " + (cost * 2));total+=cost*2;bill = bill + "POTATO\t\t2 KG\t" + cost*2 + "\n";}
				case 3 -> {System.out.println("COST OF POTATO FOR 3 KG " + cost * 3);total+=cost*3;bill = bill + "POTATO\t\t3 KG\t" + cost*3 + "\n";}
				default -> System.out.println("PLEASE ENTER IN THE RANGE OF 1-3");
				}//close brace for kgs
				System.out.println("========================================================");
			}// close brace for potato
			case "tomato"->{//open brace for tomato
				...
				int cost = 30;
				switch (kg) {//open brace for kgs
				case 0 -> {System.out.println("COST OF TOMATO FOR HALF KG IS" + (cost / 2)); total=total+(cost/2);bill = bill + "CARROT\t\tHALF KG\t" + cost/2 + "\n";}
				case 1 ->{ System.out.println("COST OF TOMATO FOR 1 KG IS " + cost);total+=cost;bill = bill + "TOMATO\t\t1 KG\t" + cost + "\n";}
				case 2 -> {System.out.println("COST OF TOMATO FOR 2 KG " + (cost * 2));total+=cost*2;bill = bill + "TOMATO\t\t2 KG\t" + cost*2 + "\n";}
				case 3 -> {System.out.println("COST OF TOMATO FOR 3 KG " + cost * 3);total+=cost*3;bill = bill + "TOMATO\t\t3 KG\t" + cost*3 + "\n";}
				default -> System.out.println("PLEASE ENTER IN THE RANGE OF 1-3");
				}//close brace for kgs
				System.out.println("========================================================");
			}	//CLOSE brace for tomato
			case "carrot"->{//open brace for carrot
				...
				int cost = 60;
				switch (kg) {//open brace for kgs
				case 0 -> {System.out.println("COST OF CARROT FOR HALF KG IS" + (cost / 2)); total=total+(cost/2);bill = bill + "CARROT\t\tHALF KG\t" + cost/2 + "\n";}
				case 1 -> {System.out.println("COST OF CARROT FOR 1 KG IS " + cost);total+=cost;bill = bill + "CARROT\t\t1 KG\t" + cost + "\n";}
				case 2 -> {System.out.println("COST OF CARROT FOR 2 KG " + (cost * 2));total+=cost*2;bill = bill + "CARROT\t\t2 KG\t" + cost*2 + "\n";}
				case 3 -> {System.out.println("COST OF CARROT FOR 3 KG " + cost * 3);total+=cost*3;bill = bill + "CARROT\t\t3 KG\t" + cost*3 + "\n";}
				default -> System.out.println("PLEASE ENTER IN THE RANGE OF 1-3");
				}//close brace for kgs
				System.out.println("========================================================");
			}	//close brace for carrot
